...
import { DomainErrorFilter, toApiError } from '../../src/cabinet/domain-error.filter';
...
describe('DomainErrorFilter', () => {
  it.each([
    ...
    [new RefundAmountError('0000-066717', d('6158.41')), 422, 'REFUND_AMOUNT_INVALID'],
    [new NothingToRefundError('0000-066717'), 409, 'NOTHING_TO_REFUND'],
    [new OrderHasPaymentsError('0000-066717', d('100')), 409, 'ORDER_HAS_PAYMENTS'],
  ...
  it('should tell how much can be refunded, in hryvnias', () => {
    const apiError = toApiError(new RefundAmountError('0000-066717', d('6158.41')));
