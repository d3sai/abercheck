...
export interface Snapshot {
  ...
  /** Unpaid orders and the amount still owed on them. */
  outstanding: Totals;
  unmatched: Totals;
}
...
export interface PeriodStats {
  payments: Totals;
  refunds: Totals;
  /** Orders created in the period; amount is their total amount due. */
  ordersCreated: Totals;
  /** Payments of the period by the current status of their order. */
