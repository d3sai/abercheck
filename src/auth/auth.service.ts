...
// Checking unknown logins against a throwaway hash keeps response time from revealing which logins exist.
...
export class AuthService {
  ...
  /**
   * ADMIN_TELEGRAM_IDS only seeds the first admins. Once an active admin exists, the cabinet decides:
   * the list still admits people nobody has reviewed yet, but never overrides a role or a revoked access.
   */
